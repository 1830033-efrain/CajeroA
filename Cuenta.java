...
public class Cuenta {
    ...
    static String rutaCuenta= ("C:/Users/Acer aspire A515/Desktop/CAJERO/CajeroAutomatico/src/main/resources/cuentas.txt");
    public static List<Tarjeta> textoCuenta;
    public int i=0,cont=0;
    static float saldo;

    public List<Tarjeta> CargarCuenta(){
